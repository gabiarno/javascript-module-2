...
let restaurantFinderApplication = {
  ...
  findAvailableRestaurants: function (numberOfPeople) {
    ...
    this.restaurants.forEach((restaurant) => {
      if (
        ...
        restaurantsAvailable.push(restaurant.name);
      }
    });
  ...
  findRestaurantServingDish: function (dishName) {
    ...
    const restaurantsSelected = this.restaurants.filter(isInmenu);
    let result = [];
    console.log("selected", restaurantsSelected);
    restaurantsSelected.forEach(element => {
